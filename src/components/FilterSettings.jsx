...
const FilterSettings = () => {
  ...
  return (
    <div className="w-100 p-2 bg-dark-secondary border-r border-dark-border h-screen overflow-y-auto flex flex-col custom-scrollbar">
      {/* Tabs */}
      <div className="flex border-b border-dark-border">
        <button
          onClick={() => setActiveTab('Filters')}
          className={`flex-1 px-4 py-3 text-sm font-medium transition-colors ${activeTab === 'Filters'
        ...
        <button
          ...
          className={`flex-1 px-4 py-3 text-sm font-medium transition-colors flex items-center justify-center gap-2 ${activeTab === 'Saved Searches'
            ? 'text-white border-b-2 border-white'
            : 'text-gray-400 hover:text-white'
            }`}
        >
        ...
        <button
          ...
          className={`flex-1 px-4 py-3 text-sm font-medium transition-colors flex items-center justify-center gap-2 ${activeTab === 'Recent'
            ? 'text-white border-b-2 border-white'
            : 'text-gray-400 hover:text-white'
            }`}
        >
      ...
      {activeTab === 'Filters' && (
        <div className="flex-1 p-4 space-y-4">
          ...
          {/* Collapsed Sections */}
          {['sector', 'dealValue', 'dealDetails', 'dealParticipants'].map((section) => (
